...
#' Default: \code{pal = \link{unhcr_pal}}.
#'
...
#' For the palettes defined by \strong{unhcr}, \code{n} is set to a pre-defined selection of
...
#' usecol(pal = unhcr_pal, n =  4)     # selecting n dedicated colors
#' usecol(pal = unhcr_pal, n = 20)     # extending color palette
#'
...
usecol <- function(pal = unhcr_pal,
  ...
  if ( all(unlist(lapply(unhcr_all_pal, exists))) ) {  # test whether the palettes in unhcr_all_pal are defined.

    # Test whether equal to any palette:
    all_pals1 <- lapply(unhcr_all_pal, get)  # get all palettes from the first part.
  ...
  if ( !use_col_ramp ) {
    ...
    if ( any(pal_ix) & length(pal_inp) >= n) {
      ...
      pal_name <- unhcr_all_pal[pal_ix]  # get palette name

      pal <- pal_inp  # redefine.

      # Define sets of known palettes:
      set1 <- pal_name %in% c("unhcr_pal_blue",
                              "unhcr_pal_grey",
                              "unhcr_pal_green",
                              "unhcr_pal_red",
                              "unhcr_pal_yellow")
      set2 <- pal_name %in%   "unhcr_pal_darkblue"
      set3 <- pal_name %in%   "unhcr_pal"
      set4 <- pal_name %in% c("unhcr_pal_primary",
                              "unhcr_pal_graphic")
      ...
      out_col <- switch(pal_set,
                        ...
                        switch(
                          ...
                          # 10
                          pal  # all 11 colors of unhcr_pal
                        ),
...
#' \enumerate{
#'
#'   \item if \code{pal = "unhcr_all_pal"} or a list of multiple color palettes:
#'
...
#' Default: \code{pal = "unhcr_pal"}.
#'
#' Recognized keywords are:
#'
#' \enumerate{
#'
#'   \item \code{"unhcr_pal"}: All preferred colors and their gradients.
#'
#'   \item \code{"unhcr_pal_graphic"}: All preferred colors and their gradients.
#'
#'   \item \code{"unhcr_all_pal"}: All preferred colors and their gradients.
#'
#'   \item \code{"unhcr_pal_primary"}: All preferred colors and their gradients.
#'
#'   \item \code{"unhcr_pal_blue"}: All preferred colors and their gradients.
#'
#'   \item \code{"unhcr_pal_grey"}: All preferred colors and their gradients.
#'
#'   \item \code{"unhcr_pal_darkblue"}: All preferred colors and their gradients.
#'
#'   \item \code{"unhcr_pal_green"}: All preferred colors and their gradients.
#'
#'   \item \code{"unhcr_pal_red"}: All preferred colors and their gradients.
#'
#'   \item \code{ "unhcr_pal_yellow"}: All preferred colors and their gradients.
#'
#' }
#'
#' \code{seecol} does also recognize keywords (e.g., \code{"unhcr_pal"})
#'
...
#' \code{\link{unhcr_pal_all}} for the default unhcr color palette
#'
#' @examples {
...
#' seecol(c(rev(unhcr_pal_blue), unhcr_pal_green))        # combine color palettes
...
#'
#' seecol(unhcr_pal, n = 5,
#'        title = "Reduced version of unhcr_pal (n = 5)")  # reducing unhcr_pal
#' seecol(unhcr_pal_green, n = 8,
#'        title = "Extended version of unhcr_pal_green (n = 8)")  # extending unhcr_pal_green
#'
#' # Combining and extending color palettes:
#' seecol(c(rev(unhcr_pal_blue), "white", unhcr_pal_red), n = 17,
...
seecol <- function(pal = "unhcr_pal_all",  # which palette to output?
                   n = "all",
                   alpha = NA,
  ...
  keys <- c("unhcr_pal", "unhcr_pal_graphic", "unhcr_all_pal", "unhcr_pal_primary",
            "unhcr_pal_blue", "unhcr_pal_grey", "unhcr_pal_darkblue", "unhcr_pal_green", "unhcr_pal_red", "unhcr_pal_yellow"
  )
  ...
  if (by_key) {
    ...
    if (is.na(title)){
      if (pal %in% c("all", "unhcr_all_pal", "all_unhcr") ) title <- "See all unhcr color palettes"
      if (pal %in% c("graphic", "unhcr_graphic", "graphic_unhcr")) title <- "See all datagraphic unhcr color palettes"
    }
