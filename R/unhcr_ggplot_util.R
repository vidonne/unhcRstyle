...
#' @title Helper functions to stylize axis labels
#'
#' @description Directly from hrbrtheme
...
#' @name scale_x_comma
#' @title Helper functions to stylize axis labels: commas on X
#'
...
#' @name  scale_y_comma
#' @title Helper functions to stylize axis labels: commas on Y
#'
#' @rdname scale_y_comma
#' @param accuracy,scale,prefix,suffix,big.mark,decimal.mark,trim See
#'        [scales::comma_format()] or [scales::percent_format()]
#' @param ... passed on to [scales::comma_format()] or [scales::percent_format()]
...
## ToDo: ------
#  - French version of thousand separator?
#
