#' @name unhcr_style_histo_big
#' @rdname unhcr_style_histo_big
#' @title UNHCR ggplot2 theme for histogramm  with big labels for powerpoints
#'
#' @description Return ggplot2 styling for histogram with big labels for
#' powerpoints / slides.
#'
...
unhcr_style_histo_big <- function() {
    font <- "Lato"
    ggplot2::theme(
