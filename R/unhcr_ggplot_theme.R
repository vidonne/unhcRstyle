...
#' @name unhcr_theme
#' @rdname unhcr_theme
#' @title  Basic UNHCR theme for ggplot2
#' @export unhcr_theme
#' @author ipda | unhcr.org | 2020
#'
#' @description  \code{unhcr_theme} provides a basic \bold{UNHCR} theme
...
#' @name unhcr_discrete
#' @rdname unhcr_discrete
#' @title  Ggplot scale color discrete and continuous palette based on the unhcr_pal_graphic
...
#' }
unhcr_discrete <- function() { manual_pal(as.vector(t(unhcr_pal_graphic))) }


#' @name unhcr_scale_colour_discrete
#' @rdname unhcr_scale_colour_discrete
#' @title  Discrete color scales based on the UNHCR graphic palette
...
#' @name unhcr_scale_fill_discrete
#' @rdname unhcr_scale_fill_discrete
#' @title  Discrete  fill scales based on the UNHCR graphic palette
