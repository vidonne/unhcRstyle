...
# UNHCR ggplot theme
theme_unhcr <- function(base_family="Lato", base_size = 12,
  ...
  if (inherits(legend_title, "character") | legend_title == TRUE) {
    ...
    ret <- ret + theme(legend.title=element_text(size=legend_title_size, family=legend_title_family,
...
#' Ggplot scale color discrete and continuous palette based on the pal_unhcr_graphic
#'
#' @export
#' @examples
#' library(scales)
#' scales::show_col(unhcr_graphic()(9))
unhcr_discrete <- function() { manual_pal(as.vector(t(pal_unhcr_graphic))) }

#' Discrete color & fill scales based on the UNHCR graphic palette
#'
#' See [unhcr_discrete()].
#'
#' @md
...
#' @rdname scale_unhcr
#' @export
scale_colour_discrete_unhcr <- function(...) { discrete_scale("colour", "pal_unhcr_graphic", unhcr_discrete(), ...) }


#' @export
#' @rdname scale_ipsum
scale_color_discrete_unhcr <- scale_colour_discrete_unhcr

#' @export
#' @rdname scale_ipsum
scale_fill_discrete_unhcr <- function(...) { discrete_scale("fill", "pal_unhcr_graphic", unhcr_discrete(), ...) }


## ToDo: ------
#  - axis_title TRUE/FALSE?
#  - Fix example
